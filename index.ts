...
async function main() {
  ...
  const amountIn = 3000 * Number(('1' + '0'.repeat(TokenA.decimals)))
  ...
  for (let limit = 10; limit > 0; limit--) {
    ...
    console.log(`The amount out of a ${amountIn} ${TokenA.symbol} swap is ${quotedAmountOut} ${TokenB.symbol} ${TokenB.decimals}`)
  }
